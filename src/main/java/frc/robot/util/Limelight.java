...
public class Limelight {
     ...
     * The fitted bounding
     * box is a rectangular convex hull surrounding the selected pixels, while the
     * rough bounding box
     ...
     * bounding box is a
     * rectangular convex hull surrounding the selected pixels, while the rough
     * bounding box is a
     ...
     *         These values
     *         place the target as the origin and represent the camera's orientation
     *         relative to the
     *         target.
     */
