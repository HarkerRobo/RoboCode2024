...
public class Drivetrain extends SubsystemBase {
    ...
    private static Matrix<N3, N1> stateStdDevs = VecBuilder.fill(0.01, 0.01, 0.1); // increase to trust encoder (state)
                                                                                        // measurements less
    private static Matrix<N3, N1> visionStdDevs = VecBuilder.fill(0.1, 0.1, 0.3); // increase to trust vsion
                                                                                        // measurements less
