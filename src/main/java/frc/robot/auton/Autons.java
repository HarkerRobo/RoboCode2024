...
public class Autons
{
    public static final SequentialCommandGroup fourNotePath = new SequentialCommandGroup(
        new SwervePositionController(Trajectories.startToNote1_four, () -> Rotation2d.fromDegrees(180), true),
        new SwervePositionController(Trajectories.note1ToShoot1_four, () -> Rotation2d.fromDegrees(180), true),
        new SwervePositionController(Trajectories.shoot1ToNote2_four, () -> Rotation2d.fromDegrees(180), true),
        new SwervePositionController(Trajectories.note2ToShoot2_four, () -> Rotation2d.fromDegrees(180), true),
        new SwervePositionController(Trajectories.shoot2ToNote3_four, () -> Rotation2d.fromDegrees(-157.83), true),
    ...
    public static final SequentialCommandGroup threeNotePath = new SequentialCommandGroup(
        ...
        new SwervePositionController(Trajectories.shoot1ToMiddle1_three, () -> Rotation2d.fromDegrees(140.1), true),
        new SwervePositionController(Trajectories.middleToNote1_three, () -> Rotation2d.fromDegrees(180), true),
        new SwervePositionController(Trajectories.noteToMiddle2_three, () -> Rotation2d.fromDegrees(180), true),
        new SwervePositionController(Trajectories.middle2ToShoot2_three, () -> Rotation2d.fromDegrees(180), true),
        new SwervePositionController(Trajectories.shoot2ToNote2_three, () -> Rotation2d.fromDegrees(138.59), true),
    ...
    (
        new SwervePositionController(Trajectories.startToNote1_six, () -> Rotation2d.fromDegrees(180), true),
        new SwervePositionController(Trajectories.note1ToShoot1_six, () -> Rotation2d.fromDegrees(180), true),
        new SwervePositionController(Trajectories.shoot1ToNote2_six, () -> Rotation2d.fromDegrees(158.62), true),
        ...
        new SwervePositionController(Trajectories.shoot2ToNote3_six, () -> Rotation2d.fromDegrees(180), true),
        new SwervePositionController(Trajectories.note3ToShoot3_six, () -> Rotation2d.fromDegrees(-156.72), true),
        new SwervePositionController(Trajectories.shoot3ToNote4_six, () -> Rotation2d.fromDegrees(180), true),
        new SwervePositionController(Trajectories.note4ToShoot4_six, () -> Rotation2d.fromDegrees(-164.18), true),
        new SwervePositionController(Trajectories.shoot4ToNote5_six, () -> Rotation2d.fromDegrees(180), true),
