...
//         public static final Command PRE_ALIGN_CLIMB = new MoveToPosition(RobotMap.Elevator.STAGE_HEIGHT);

//         public static final Command POST_ALIGN_CLIMB = new ZeroElevator();

//         public static final Command FULL_SHOOT_TRAP = new MoveToPosition(RobotMap.Elevator.TRAP_HEIGHT).alongWith(new PivotToAngle(RobotMap.Pivot.Goal.TRAP))
